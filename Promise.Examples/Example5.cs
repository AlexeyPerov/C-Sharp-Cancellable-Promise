...
{
    /// <summary>
    /// This example downloads search results from google, extracts the links, follows all (absolute) links and
    /// combines all async operations in a single operation using the All function.
    /// </summary>
